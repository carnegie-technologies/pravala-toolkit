...
namespace Pravala
{
/// @brief Android-specific wrapper around UdpFdSocket that binds the socket to a specific network.
class AndroidUdpFdSocket: public UdpFdSocket
{
    public:
        /// @brief Constructor.
        ...
        AndroidUdpFdSocket ( SocketOwner * owner, int64_t networkId );

    protected:
        /// @brief Destructor
        virtual ~AndroidUdpFdSocket();
