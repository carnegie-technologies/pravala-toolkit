...
namespace Pravala
{
/// @brief Config option that holds a single string set value
class ConfigStringSet: public ConfigOpt
{
    public:
        /// @brief Constructor.
        ...
        inline const HashSet<String> & value() const
        {
            return _value;
        }
    ...
    protected:
        ...
        HashSet<String> _defaultValue; ///< Default value
        HashSet<String> _value; ///< Current value
