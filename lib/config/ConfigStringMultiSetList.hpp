...
namespace Pravala
{
/// @brief Config option that holds a single string "multi set" list value
/// "Multi set" list means that every time it is set it will append the new value to the list.
class ConfigStringMultiSetList: public ConfigOpt
{
    public:
        /// @brief Constructor.
        ...
        ConfigStringMultiSetList ( uint8_t flags, const char * cfgName, const String & helpText );
        ...
        /// @param [in] helpText The help text for this option.
        ConfigStringMultiSetList ( const char * cmdLineName, char cmdLineFlag, const String & helpText );
        ...
        inline const StringList & value() const
        {
            return _value;
        }
    ...
    protected:
        StringList _defaultValue; ///< Default value
        StringList _value; ///< Current value
