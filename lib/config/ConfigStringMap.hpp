...
namespace Pravala
{
/// @brief Config option that holds a map of string values
class ConfigStringMap: public ConfigOpt
{
    public:
        /// @brief Constructor
        /// It creates an option without default values set
        /// @param [in] flags The initial flags to set
        /// @param [in] name The name filter for this option
        /// @param [in] helpText The help text for this option
        ConfigStringMap ( uint8_t flags, const char * name, const String & helpText );
        ...
        inline const HashMap<String, String> & value() const
        {
            return _value;
        }
    ...
    protected:
        HashMap<String, String> _defaultValue; ///< Default value
        HashMap<String, String> _value; ///< Current value
