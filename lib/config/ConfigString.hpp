...
namespace Pravala
{
/// @brief Config option that holds a single string value
class ConfigString: public ConfigOpt
{
    public:
        /// @brief Constructor.
        ...
        ConfigString ( uint8_t flags, const char * cfgName, const String & helpText, const char * defValue = 0 );
        ...
        /// @param [in] helpText The help text for this option.
        /// @param [in] defValue Default value to set (if not 0).
        ConfigString ( const char * cmdLineName, char cmdLineFlag, const String & helpText, const char * defValue = 0 );
        ...
        ConfigString (
            ...
            const char * cfgName, const String & helpText, const char * defValue = 0 );
        ...
        /// @brief Returns the value as a null-terminated string
        ...
        /// @brief Checks if the string value is empty.
