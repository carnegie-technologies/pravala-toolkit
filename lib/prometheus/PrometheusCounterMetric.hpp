...
namespace Pravala
{
/// @brief A Prometheus counter metric which contains 1 or more child counters
class PrometheusCounterMetric: public PrometheusMetric
{
    public:
        /// @brief A constructor for a counter metric with labels
        ...
        PrometheusCounterMetric (
            ...
            PrometheusMetric ( PrometheusMetric::PromCounter, timestampMode, name, labelNames, help )
        {
        }
};
}
